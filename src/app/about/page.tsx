        ...
        <main className="min-h-screen p-16">
            <div className="max-w-4xl mx-auto space-y-8">
                <div>
                    ...
                    <p className="p-10 text-xl text-gray-300 flex justify-center">Hi, I&apos;m Joshua DeJesus, a CS student at Binghamton University. From a young age I knew that I&apos;d want to do something in the technology field. I was always messing with computers and had been fascinated with how programs were created. Growing up playing video games, I loved immersing myself into new and different environments, playing through heartfelt stories, and competing online with and against friends. My goal is to be able to bring that same joy and inspiration to more people around the world.</p>
                    ...
                    <ul className="list-disc text-xl mx-20">
                        ...
                        <li>Binghamton University: Present</li>
                    </ul>
